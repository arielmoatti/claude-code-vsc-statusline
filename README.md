...
החישוב המתבקש הוא `אחוז ÷ חלק השבוע שעבר`. הוא **שגוי בצורה מסוכנת**: השבוע מתקדם לפי הזמן שחולף, בין אם אתם עובדים ובין אם אתם ישנים, אבל את המכסה אתם שורפים רק כשאתם עובדים. שינה של שמונה שעות "משפרת" את המספר לבד.

אותם 14% בדיוק, בשתי הדרכים:

<table dir="rtl">
<tr><th>רגע</th><th>לפי הזמן שחלף</th><th>לפי שעות עבודה</th></tr>
...
לכן הקצב כאן נמדד **לשעת עבודה**, ולא לכל שעה שחלפה. התוסף רושם דגימה בכל רענון לקובץ קטן (`<tmp>/claude/statusline-usage-history.jsonl`), ומשחזר ממנו כמה שעות באמת עבדתם: מקטע נחשב עבודה רק אם המכסה השבועית זזה בו. פער שאף אחד לא דגם בו לא נספר כעבודה.
